...
const ChangeEmpauthority = ({ information }) => {
    ...
    const onSubmit = (data) => {
        ...
        const formInfo = {
            ...data,
            typeofCondition: "EmployeeToCandidate",
        };
    ...
    return (
        <>
            {
                information?.role === process.env.REACT_APP_EMPLOYEER_USER ? <div className='bg-secondary/20 shadow-lg p-10 rounded-2xl m-3'>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="grid md:grid-cols-2 md:gap-6">
                            <div className="relative z-0 w-full mb-6 group">
                                ...
                                <label for="companyName" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Resent/Previous Company Name </label>
                            ...
                            <div className="relative z-0 w-full mb-6 group">
                                ...
                                <label for="companyaddress" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Resent/Previous Company Location </label>
                        ...
                        <div className="grid md:grid-cols-2 md:gap-6">
                            <div className="relative z-0 w-full mb-6 group">
                                <input type="text" name="position" id="position"  {...register("position")} className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                                {errors.position && <p role="alert">{errors?.position?.message}</p>}
                                <label for="position" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Resent /Previous Job Position</label>
                ...
                </div> : "Only Employee Account Holder Can be Access "
            }
        </>
    );
};

export default ChangeEmpauthority;