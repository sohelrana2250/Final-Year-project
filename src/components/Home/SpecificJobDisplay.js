...
const SpecificJobDisplay = ({ list }) => {

    const { position, companyName, location, employmentType, p_date,
        date,
        salaryRange, _id } = list || {};
        ...
        <>
            ...
            >
                ...
                <div className='flex justify-between items-center mt-5'>
                    ...
                    <button disabled={today.getTime() >= date ? true : false} type="button" onClick={() => navigate(`/details-job-info/${_id}`)} className="btn btn-outline btn-success btn-sm">Details</button>
                </div>
            </div>
        </>
...
export default SpecificJobDisplay;